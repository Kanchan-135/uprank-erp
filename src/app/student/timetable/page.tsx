  ...
  return (
    <DashboardLayout allowedRoles={["STUDENT"]}>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Class Timetable & Schedule</h1>
          <p className="text-xs text-slate-500 mt-1">Weekly schedule of course lectures, instructors, and assigned rooms</p>
        </div>
            ...
            return (
              <div key={day} className="bg-white rounded-2xl border border-slate-200/80 shadow-xs flex flex-col">
                <div className="p-3.5 bg-slate-50 border-b border-slate-100 text-center rounded-t-2xl">
                  ...
                  <span className="text-[10px] text-slate-400">{daySlots.length} Lectures</span>
                </div>
